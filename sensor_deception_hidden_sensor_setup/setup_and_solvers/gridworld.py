...
class GridworldGui(Gridworld):
    def __init__(self, initial, nrows=8, ncols=8, robotmdp=MDP(), targets=[], obstacles=[], unsafe_states=[], size=100):
        super().__init__(initial, nrows, ncols, robotmdp, targets, obstacles, unsafe_states)
